(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('postcss'), require('path'), require('camel-case'), require('prettier'), require('round-to')) :
    typeof define === 'function' && define.amd ? define(['postcss', 'path', 'camel-case', 'prettier', 'round-to'], factory) :
    (global = global || self, factory(global.postcss, global.path, global.camelCase, global.prettier, global.round));
}(this, function (postcss, path, camelCase, prettier, round) { 'use strict';
